...
// Langue disponible
  ...
  if (isset($_GET['langue']) && in_array($_GET['langue'], $languesDisponibles)) 
  {
    ...
    // C2 - Retenir le choix de langue de l'utilisateur, mais comment?
  ...
  <div id="conteneur" class="page-<?php echo $page ?>">
    <header>
      <div class="barre-haut">
        ...
        <?php
          // Afficher le lien vers la page d'accueil uniquement lorsque nous ne sommes pas sur la page d'accueil
          if ($page != 'accueil') {
        ?> 
      ...
      <div class="info-utile">
        <p class="aujourdui"><?php echo $en_heuresOuverture; ?></p>
        <p class="addresse"><?= $en_adresse; ?></p>
        <p class="telephone"><?= $en_telephone; ?></p>
      </div>
      <?php } ?>
      <nav class="nav-principale">
        <a href="menu.php" title="<?= $en_altMenu; ?>" class="<?php if ($page == 'menu') {echo 'actif';} ?>">
        ...
        <a href="vins.php" title="<?= $en_altVins; ?>" class="<?php if ($page == 'vins') {echo 'actif';} ?>">
        ...
        <a href="javascript: void(0);" title="<?= $en_altReservation; ?>" class="<?php if ($page == 'reservation') {echo 'actif';} ?>">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="130px" height="130px" viewBox="0 0 130 130" enable-background="new 0 0 130 130" xml:space="preserve">
